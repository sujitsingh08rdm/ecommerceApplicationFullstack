...
const brandWithIcon = [
  { id: "nike", label: "Nike", icon: Ampersand },
  { id: "adidas", label: "Adidas", icon: Asterisk },
  { id: "puma", label: "Puma", icon: CandlestickChart },
  { id: "levi", label: "Levi's", icon: AudioWaveform },
  { id: "zara", label: "Zara", icon: Tv },
    ...
    <div className="flex flex-col min-h-screen">
      <div className="relative w-full h-[600px] overflow-hidden">
        ...
        <Button
          ...
          onClick={() =>
            setCurrentSlide(
              (nextSlide) => (nextSlide + 1 + slides.length) % slides.length
            )
          }
        >
